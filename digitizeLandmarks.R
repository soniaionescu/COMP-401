...
digitize_landmark <- function(filename){
    ...
    for(i in 1:nrow(fishPhotos)){
        ...
        allpoints <- rbind(locator1, locator2, locator3, locator4, locator5, locator6, locator7, locator8)
        ...
        dataFrameOfCoord <- data.frame(x=scale[[1]], y = scale[[2]]) ## this creates a data frame with x coordinates in the x column and y coordinates in the y column
